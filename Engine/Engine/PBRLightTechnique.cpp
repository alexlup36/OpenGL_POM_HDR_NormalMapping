...
PBRLightTechnique::PBRLightTechnique()
...
bool PBRLightTechnique::init()
{
	// Initialize base
	if (BaseTechnique::init() == false)
	{
		std::cout << "Failed to initialize base technique - PBRLightTechnique. \n";
		return false;
	}

	// Add shaders
	if (addShader(GL_VERTEX_SHADER, ".\\Shaders\\pbr.vert") == false)
	{
		std::cout << "Failed to add vertex shader - PBRLightTechnique. \n";
		return false;
	}
	if (addShader(GL_FRAGMENT_SHADER, ".\\Shaders\\pbr.frag") == false)
	{
		std::cout << "Failed to add fragment shader - PBRLightTechnique. \n";
		return false;
	}
	...
	if (finalize() == false)
	{
		std::cout << "Failed to link the program - PBRLightTechnique. \n";
		return false;
	}
...
void PBRLightTechnique::addDirectionalLight(DirectionalLight& dirLight)
{
...
void PBRLightTechnique::addPointLight(PointLight& pointLight)
{
...
void PBRLightTechnique::addSpotLight(SpotLight& spotLight)
{
	// Add light source to point light vector list
...
void PBRLightTechnique::setDirectionalLight(const DirectionalLight& dirLight)
{
...
void PBRLightTechnique::setPointLight(const PointLight& pointLight)
{
...
void PBRLightTechnique::setSpotLight(const SpotLight& spotLight)
{
...
void PBRLightTechnique::addLightSourceMesh(PointLight* lightSource)
{
