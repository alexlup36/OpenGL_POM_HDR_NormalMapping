#ifndef PBRLIGHTTECHNIQUE_H
#define PBRLIGHTTECHNIQUE_H
...
class PBRLightTechnique : public TransformTechnique
{
public:
	PBRLightTechnique();
	virtual ~PBRLightTechnique();
