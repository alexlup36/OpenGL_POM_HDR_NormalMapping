...
PhongLightTechnique::PhongLightTechnique()
...
void PhongLightTechnique::update()
{
	// Get active camera
...
void PhongLightTechnique::setDirectionalLight(const DirectionalLight& dirLight)
{
...
void PhongLightTechnique::setPointLight(const PointLight& pointLight)
{
...
void PhongLightTechnique::setSpotLight(const SpotLight& spotLight)
{
...
void PhongLightTechnique::addLightSourceMesh(PointLight* lightSource)
{
	// Build point light object name
	GLuint lightCount = (GLuint)(m_vPointLights.size() - 1);
	std::string sPointLightObjectName = "pointLightPhongMesh" + std::to_string(lightCount);
