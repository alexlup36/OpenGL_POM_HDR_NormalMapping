#ifndef PHONGLIGHTTECHNIQUE_H
#define PHONGLIGHTTECHNIQUE_H
...
class PhongLightTechnique : public TransformTechnique
{
public:
	PhongLightTechnique();
	virtual ~PhongLightTechnique();
